...
{
    public class ProjectServices<T> : IRepository<T> where T : Project
    {
        ...
        public void Add(T entity)
        {
            using (var trans = dbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    if (Entities.Any(x => x.ProjectName == entity.ProjectName))
                    {
                ...
                try
                {
                    if (entities.Any())
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if (!_entities.Any(x => x.ProjectName == entity.ProjectName || x.PoId == entity.PoId))
                                {
        ...
        {
            var userHt = dbContext.qa_projects.FirstOrDefault(x => x.Id == id);
