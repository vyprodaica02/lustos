<template>
  <v-container>
    ...
    />
    <AddProjectComponent :openAdd="showAdd" @clickShowAdd="clickShowAdds" />
  </v-container>
</template>
<script>
...
import UpdateProjectComponent from "./UpdateProjectComponent.vue";
...
export default {
  ...
  data() {
    return {
      ...
      singleSelect: false,
      DataLotus: "ProJect",
      DataInput: ["fisrtName", "email", "address"],
      inputValues: {
        email: "",
        fisrtName: "",
        address: "",
